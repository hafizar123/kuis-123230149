...
List<Product> products = [
  ...
  Product(
    ...
    price: 450000,
    rating: 4.7,
    description: "Keyboard mekanikal dengan switch tactile yang responsif, dilengkapi lampu RGB dan desain kokoh untuk pengalaman mengetik yang nyaman.",
    isFavorite: false,
  ),
  Product(
    name: "Gaming Headset",
  ...
  Product(
    ...
    price: 800000,
    rating: 4.4,
    description: "Smartwatch modern dengan fitur pemantau detak jantung, penghitung langkah, dan notifikasi smartphone langsung di pergelangan tangan.",
    isFavorite: false,
  ),
  Product(
    ...
    price: 275000,
    rating: 4.3,
    description: "Speaker bluetooth portabel dengan suara bass yang kuat dan baterai tahan hingga 10 jam pemakaian.",
    isFavorite: false,
  ),
  Product(
  ...
  Product(
    ...
    price: 180000,
    rating: 4.2,
    description: "USB-C hub multifungsi dengan port HDMI, USB 3.0, dan SD card reader untuk meningkatkan konektivitas laptop Anda.",
    isFavorite: false,
  ),
  Product(
  ...
  Product(
    ...
    price: 130000,
    rating: 4.1,
    description: "Lampu meja LED hemat energi dengan tingkat kecerahan yang dapat diatur sesuai kebutuhan belajar atau bekerja.",
    isFavorite: false,
  ),
  Product(
    name: "Phone Tripod",
    ...
    price: 90000,
    rating: 4.0,
    description: "Tripod smartphone fleksibel yang cocok untuk fotografi, live streaming, atau membuat konten video.",
    isFavorite: false,
  ),
];